                        ...
                        <div class="row account-info">
                            <div class="col-sm-12">
                                <div class="edit-profile">
                                    <a href="<?php echo e(route('student.edit-profile-form')); ?>">
                                        Edit-profile
                                    </a>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <p class="detail"><?php echo e(auth()->user()->username); ?></p>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <label for="">Email</label>
                                <p class="detail"><?php echo e(auth()->user()->email); ?></p>
                            </div>
                            <div class="col-sm-12 col-md-6">
                                <label for="">Phone Number</label>
                                <p class="detail"><?php echo e(auth()->user()->phone); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="course-detail">
                            ...
                            <div class="details">
                                <ul>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);"><?php echo e($course->coursename); ?></a>
                                    </li>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Final-year-project\resources\views/student/user-profile.blade.php ENDPATH**/ ?>