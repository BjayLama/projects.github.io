  ...
  <aside class="main-sidebar sidebar-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <img src="<?php echo e(asset('backend/assets/images/user.png')); ?>" alt="">
          <h5 class="pt-20"> 
            Welcome
          </h5>
        </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo e(route('admin.users.list')); ?>" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo e(route('admin.contents.index')); ?>" class="nav-link">
                <i class="nav-icon fas fa-book"></i>
              <p>
                Contents
              </p>
...
<?php /**PATH D:\xampp\htdocs\Final-year-project\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>